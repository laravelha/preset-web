        ...
        <div class="flex flex-col justify-around h-full">
            <div>
                ...
                <ul class="list-reset">
                    ...
                    <li class="inline pr-8">
                        <a href="https://laravelha.github.io/generator/" class="no-underline hover:underline text-sm font-normal text-teal-800 uppercase" title="Laravelha">Laravelha</a>
                    </li>
                    <li class="inline pr-8">
                        <a href="https://github.com/laravelha" class="no-underline hover:underline text-sm font-normal text-teal-800 uppercase" title="GitHub">GitHub</a>
                    </li>
                    <li class="inline pr-8">
